...
function NoProjectSelected({onStartAddProject}) {
    return <div className="mt-24 text-center w-2/3">
        ...
        <h2 className='text-xl font-bold text-stone-500 my-4'>Kein Projekt gewählt</h2>
        <p className='text-stone-400 mb-4'>Wählen Sie ein Projekt aus oder beginnen Sie mit einem neuen Projekt.</p>
        <p className='mt-8'>
